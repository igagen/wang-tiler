(function() {
  describe("Graph", function() {
    ...
    return describe("maxFlow", function() {
      ...
      it("should correctly partition the nodes along the min-cut", function() {
        var maxFlow;
        maxFlow = this.graph.computeMaxFlow();
      ...
      it("should determine the correct max flow when nodes contain bidirectional edges between them", function() {
        var maxFlow;
        this.graph = new Graph;
        this.source = this.graph.source;
        this.sink = this.graph.sink;
        ...
        this.dToSink = this.d.addEdge(this.sink, 4);
        return maxFlow = this.graph.computeMaxFlow();
      });
